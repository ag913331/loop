// The Python course definition. Section lesson manifests stay co-located with
// their pages under app/learn/python/<section>/lessons.ts; this file assembles
// them into the module/section structure the navigation reads from.
//
// To add a section: create app/learn/python/<slug>/lessons.ts + page files, then
// import its LESSONS here and add a section entry to the right module.

import type { Course } from "./types";

import { LESSONS as INTRO_LESSONS } from "@/app/learn/python/intro/lessons";
import { LESSONS as MEET_LESSONS } from "@/app/learn/python/meet-python/lessons";
import { LESSONS as INSTALL_LESSONS } from "@/app/learn/python/install/lessons";
import { LESSONS as BASICS_LESSONS } from "@/app/learn/python/basics/lessons";
import { LESSONS as LITERALS_LESSONS } from "@/app/learn/python/literals/lessons";
import { LESSONS as OPERATORS_LESSONS } from "@/app/learn/python/operators/lessons";
...
import { LESSONS as LISTS_LESSONS } from "@/app/learn/python/lists/lessons";
import { LESSONS as SORTING_LESSONS } from "@/app/learn/python/sorting/lessons";
import { LESSONS as LIST_OPS_LESSONS } from "@/app/learn/python/list-ops/lessons";
import { LESSONS as ADVANCED_LISTS_LESSONS } from "@/app/learn/python/advanced-lists/lessons";
import { LESSONS as FUNCTIONS_LESSONS } from "@/app/learn/python/functions/lessons";
import { LESSONS as PARAMETERS_LESSONS } from "@/app/learn/python/parameters/lessons";
import { LESSONS as RETURN_LESSONS } from "@/app/learn/python/return-values/lessons";
import { LESSONS as SCOPES_LESSONS } from "@/app/learn/python/scopes/lessons";
import { LESSONS as MULTI_PARAM_LESSONS } from "@/app/learn/python/multi-parameter/lessons";
import { LESSONS as TUPLES_DICTS_LESSONS } from "@/app/learn/python/tuples-dicts/lessons";
import { LESSONS as EXCEPTIONS_LESSONS } from "@/app/learn/python/exceptions/lessons";
